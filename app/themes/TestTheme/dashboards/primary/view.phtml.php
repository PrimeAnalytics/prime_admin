<head><link href="/themes/TestTheme/assets/global/images/favicon.png" rel="stylesheet">
<link href="/themes/TestTheme/assets/global/css/style.css" rel="stylesheet">
<link href="/themes/TestTheme/assets/global/css/theme.css" rel="stylesheet">
<link href="/themes/TestTheme/assets/global/css/ui.css" rel="stylesheet">
<link href="/themes/TestTheme/assets/admin/layout1/css/layout.css" rel="stylesheet">
...
<!-- BEGIN USER DROPDOWN --><li class="dropdown" id="language-header">
...
<li class="clearfix">
              ...
              <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                <img src="../assets/global/images/avatars/user1.png" alt="user image"><span class="username">Hi, John Doe</span>
                </a>
                <ul class="dropdown-menu">
<li>
...
<?php echo $region['9']; ?>
        ...
        <div class="inner">
          <div class="builder-container">
            ...
            <div class="layout-option">
              ...
              <input data-layout="sidebar" id="switch-sidebar" type="checkbox" class="switch-input" checked><span class="switch-label" data-on="On" data-off="Off"></span>
            ...
            <div class="layout-option">
              ...
              <label class="switch pull-right">
              <input data-layout="sidebar-hover" id="switch-sidebar-hover" type="checkbox" class="switch-input"><span class="switch-label" data-on="On" data-off="Off"></span>
              <span class="switch-handle"></span>
              </label>
            </div>
            <div class="layout-option">
              ...
              <label class="switch pull-right">
              <input data-layout="submenu-hover" id="switch-submenu-hover" type="checkbox" class="switch-input"><span class="switch-label" data-on="On" data-off="Off"></span>
              <span class="switch-handle"></span>
              </label>
            </div>
            <div class="layout-option">
              ...
              <label class="switch pull-right">
              <input data-layout="topbar" id="switch-topbar" type="checkbox" class="switch-input" checked><span class="switch-label" data-on="On" data-off="Off"></span>
              <span class="switch-handle"></span>
              </label>
            </div>
            <div class="layout-option">
              ...
              <label class="switch pull-right">
              <input data-layout="boxed" id="switch-boxed" type="checkbox" class="switch-input"><span class="switch-label" data-on="On" data-off="Off"></span>
              <span class="switch-handle"></span>
              </label>
            </div>
      ...
      <!-- END BUILDER -->
    </section><!-- BEGIN QUICKVIEW SIDEBAR --><div id="quickview-sidebar">
          ...
          <div class="tab-pane fade active in" id="chat">
            <div class="chat-body current">
              <div class="chat-search">
                <form class="form-inverse" action="#" role="search">
                  <div class="append-icon">
                    <input type="text" class="form-control" placeholder="Search contact..."><i class="icon-magnifier"></i>
                  </div>
                </form>
              </div>
              <div class="chat-groups">
                ...
                <ul>
<li>
<i class="turquoise"></i> Favorites</li>
                  <li>
<i class="turquoise"></i> Office Work</li>
                  <li>
<i class="turquoise"></i> Friends</li>
                </ul>
</div>
              <div class="chat-list">
...
<li class="clearfix">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="../assets/global/images/avatars/avatar5.png" alt="avatar"><div class="pull-right badge badge-danger">3</div>
                    </div>
                    <div class="user-details">
...
<li class="clearfix">
                    <div class="user-img">
                      <img src="../assets/global/images/avatars/avatar7.png" alt="avatar"><div class="pull-right badge badge-danger">3</div>
                    </div>
                    <div class="user-details">
...
<li class="img">
              ...
              <div class="conversation-message">
                <input type="text" placeholder="Your message..." class="form-control form-white send-message"><div class="item-footer clearfix">
          ...
          <div class="tab-pane fade" id="settings">
            <div class="settings">
              ...
              <div class="setting">
                ...
                <label class="switch pull-right">
                <input type="checkbox" class="switch-input" checked><span class="switch-label" data-on="On" data-off="Off"></span>
                <span class="switch-handle"></span>
                </label>
              ...
              <div class="setting">
                ...
                <label class="switch pull-right">
                <input type="checkbox" class="switch-input"><span class="switch-label" data-on="On" data-off="Off"></span>
                <span class="switch-handle"></span>
                </label>
                <p class="setting-info">Lorem ipsum dolor sit amet consectetuer.</p>
              </div>
    ...
    <div id="morphsearch" class="morphsearch">
      <form class="morphsearch-form">
        <input class="morphsearch-input" type="search" placeholder="Search..."><button class="morphsearch-submit" type="submit">Search</button>
      </form>
      <div class="morphsearch-content withScroll">
        <div class="dummy-column user-column">
          <h2>Users</h2>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/avatars/avatar1_big.png" alt="Avatar 1"><h3>John Smith</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/avatars/avatar2_big.png" alt="Avatar 2"><h3>Bod Dylan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/avatars/avatar3_big.png" alt="Avatar 3"><h3>Jenny Finlan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/avatars/avatar4_big.png" alt="Avatar 4"><h3>Harold Fox</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/avatars/avatar5_big.png" alt="Avatar 5"><h3>Martin Hendrix</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/avatars/avatar6_big.png" alt="Avatar 6"><h3>Paul Ferguson</h3>
          </a>
        </div>
        <div class="dummy-column">
          <h2>Articles</h2>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/1.jpg" alt="1"><h3>How to change webdesign?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/2.jpg" alt="2"><h3>News From the sky</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/3.jpg" alt="3"><h3>Where is the cat?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/4.jpg" alt="4"><h3>Just another funny story</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/5.jpg" alt="5"><h3>How many water we drink every day?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/6.jpg" alt="6"><h3>Drag and drop tutorials</h3>
          </a>
        </div>
        <div class="dummy-column">
          <h2>Recent</h2>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/7.jpg" alt="7"><h3>Design Inspiration</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/8.jpg" alt="8"><h3>Animals drawing</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/9.jpg" alt="9"><h3>Cup of tea please</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/10.jpg" alt="10"><h3>New application arrive</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/11.jpg" alt="11"><h3>Notification prettify</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="../assets/global/images/gallery/12.jpg" alt="12"><h3>My article is the last recent</h3>
          </a>
        </div>
      </div>
      <!-- /morphsearch-content -->
...
</body><script src="/themes/TestTheme/assets/global/plugins/modernizr/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/jquery/jquery-1.11.1.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/jquery/jquery-migrate-1.2.1.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/jquery-ui/jquery-ui-1.11.2.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/gsap/main-gsap.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/bootstrap/js/bootstrap.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/jquery-cookies/jquery.cookies.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/jquery-block-ui/jquery.blockUI.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/bootbox/bootbox.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/mcustom-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/bootstrap-dropdown/bootstrap-hover-dropdown.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/charts-sparkline/sparkline.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/retina/retina.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/select2/select2.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/icheck/icheck.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/backstretch/backstretch.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
<script src="/themes/TestTheme/assets/global/plugins/charts-chartjs/Chart.min.js"></script>
<script src="/themes/TestTheme/assets/global/js/builder.js"></script>
<script src="/themes/TestTheme/assets/global/js/sidebar_hover.js"></script>
<script src="/themes/TestTheme/assets/global/js/widgets/notes.js"></script>
<script src="/themes/TestTheme/assets/global/js/quickview.js"></script>
<script src="/themes/TestTheme/assets/global/js/pages/search.js"></script>
<script src="/themes/TestTheme/assets/global/js/plugins.js"></script>
<script src="/themes/TestTheme/assets/global/js/application.js"></script>
<script src="/themes/TestTheme/assets/admin/layout1/js/layout.js"></script><?php echo $this->getContent(); ?></body>