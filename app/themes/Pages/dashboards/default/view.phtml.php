...
<link href="/themes/Pages/assets/pages/css/pages.css" rel="stylesheet"></head><body><body class="fixed-header  dashboard ">
    ...
    <nav class="page-sidebar" data-pages="sidebar"><!-- BEGIN SIDEBAR MENU TOP TRAY CONTENT--><div class="sidebar-overlay-slide from-top" id="appMenu">
      ...
      <div class="sidebar-header">
        <img src="<?php echo $parm['logo']; ?>" alt="logo" class="brand" data-src="<?php echo $parm['logo']; ?>" data-src-retina="assets/img/logo_white_2x.png" width="78" height="22"><div class="sidebar-header-controls">
