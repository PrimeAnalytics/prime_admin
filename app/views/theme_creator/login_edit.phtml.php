                ...
                echo '</div>
                    ...
                    <div class="tab-pane fade" id="tab2_7">
                        ...
                        <div class="pull-right">
                            ...
                            <button id="saveLogin" class="btn btn-primary">Save</button>
                        </div>
...
<script>
    ...
    $("#previewrun").click(function () {
        var request = $.ajax({
            url: "/theme_creator/login_preview",
            type: "Post",
    ...
    $("#saveLogin").click(function () {
        $.post("/theme_creator/login_save/<?php echo $login_id; ?>", { css: csslinks.getValue(), js: jslinks.getValue(), script: jseditor.getValue(), style: csseditor.getValue(), html: htmleditor.getValue(), form: getParameters() });
    });
