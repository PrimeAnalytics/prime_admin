...
<script>
    ...
    $("#saveDashboard").click(function () {
        $.post("/theme_creator/dashboard_save/<?php echo $dashboard_id; ?>", { css: csslinks.getValue(), js: jslinks.getValue(), script: jseditor.getValue(), style: csseditor.getValue(), html: htmleditor.getValue(), form: getParameters() });
    });
