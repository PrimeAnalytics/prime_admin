...
class CanvasController extends \Phalcon\Mvc\Controller
{    /**
     * Index action
     */
    ...
    $this->view->setRenderLevel(\Phalcon\Mvc\View::LEVEL_ACTION_VIEW);
        if ($this->session->has("auth")) {
            ...
            $directory = '../app/themes/'.$auth['theme'].'/canvas/';
        }
    ...
    public function deleteCanvasAction()
    {
        $id = $this->request->getPost("id");
        $canvas = Canvas::findFirstByid($id);
        ...
        {
            $this->flash->success("Canvas was deleted successfully");
        }
