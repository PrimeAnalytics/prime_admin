    ...
    <div class="panel">
        <div class="panel-content">
            ...
            <section class="page-app app mailbox" style="">
                <aside class=" aside-md emails-list">
                    <section>
                        <div class="mailbox-page clearfix">
                            <h1 class="pull-left">Computers</h1>
                        </div>
                                    ...
                                    <div class="message-item media">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="sender" data-id="<?php echo $computer->id; ?>"><?php echo $computer->name; ?></div>
                                                <div class="subject"><span class="subject-text"><?php echo $computer->type; ?></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                ...
                <button type="button" class="btn btn-primary btn-rounded pull-right" onclick="create_new('computer')">Create New</button>
...
<script>
    ...
    $('.emails-list').on('click', '.message-item', function () {
        ...
        $('.email-content').load('/computer/edit/' + id);
    });
