...
<html>
  <head>
    <meta charset="utf-8">
      <title>Prime Analytics - Register</title>
  ...
  <body class="account2 signup" data-page="signup">
    ...
    <div class="container" id="login-block">
      ...
      <div class="account-info">
        <a href="http://primeanalytics.io" class="logo" style="height:78px; width:250px">
        </a>
        <h3>Prime Analytics</h3>
        <ul>
          <li>
            <i class="icon-magic-wand"></i> Fully customizable
          </li>
          <li>
            <i class="icon-layers"></i> Various sibebars look
          </li>
          <li>
            <i class="icon-arrow-right"></i> RTL direction support
          </li>
          <li>
            <i class="icon-drop"></i> Colors options
          </li>
          <li>
            <i class="icon-doc"></i> Page Variations
          </li>
          <li>
            <i class="icon-support"></i> Online Support
          </li>
          <li>
            <i class="icon-cloud-download"></i> Regular updates
          </li>
        </ul>
      </div>
      <div class="account-form">
        <form class="form-signup" action="/session/register" role="form" method="post">
          <h3>
          ...
          <div class="append-icon">
            <input type="text" name="organisation_name" class="form-control form-white" placeholder="Organisation" required="">
          ...
          <div class="m-t-20">
            <button type="submit"  class="btn btn-lg btn-dark btn-rounded" data-style="expand-left">Sign In</button>
          </div>
        </form>
        <div class="form-footer">
          <div class="clearfix">
            <p class="new-here">
              <a href="/session/index">Already have an account? Sign In</a>
            </p>
          </div>
        </div>
      </div>
