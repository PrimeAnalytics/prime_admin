...
<div class="modal-content">
    ...
    <?php echo $this->tag->form("theme_creator/portlet_create_copy/".$id) ?>
    <div class="modal-header">
        <h4 id="myModalLabel" class="semi-bold">Create New Portlet.</h4>
        <p class="no-margin">Please provide all the required information. </p>
    </div>
    <div class="modal-body">
        <div class="row form-row">
            <div class="col-md-6">
                <label class="form-label">Portlet Name</label>
