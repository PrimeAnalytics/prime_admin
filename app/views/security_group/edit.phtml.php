                    ...
                    <div class="grid-body no-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon  right">
                                <i class=""></i>
                                <?php
 echo $this->tag->selectStatic(array("role", "class" => "form-control",array(
            "Admin" => "Admin",
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon  right">
                                <i class=""></i>
                                <?php
 echo $this->tag->selectStatic(array("status", "class" => "form-control",array(
            "enable" => "Enable",
            "disable"   => "Disable"
        )))
                                ?>
                ...
                <p class="pull-right">
                    ...
                    <button type="button" onclick="delete_modal('users','<?php echo $user->email; ?>')" class="btn btn-danger btn-cons">Delete</button>
                </p>
                </form>
