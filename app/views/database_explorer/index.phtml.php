    ...
    <div class="panel">
        <div class="panel-content">
            ...
            <section class="page-app app mailbox" style="">
                <aside class=" aside-md emails-list" style="width:300px">
                    <section>
                        <div class="mailbox-page clearfix">
                            <h1 class="pull-left">Database Tables</h1>
                        </div>
                                    ...
                                    <div class="message-item media">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="sender"><?php echo $table['table_name']; ?></div>
...
<script>
    ...
    $('.emails-list').on('click', '.message-item', function () {
        ...
        $('.email-content').load('/database_explorer/edit/' + emailSender);
    });
